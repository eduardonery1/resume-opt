  ...
  return (
    <main className="flex flex-col items-center h-full justify-start">
      ...
      <div className="flex justify-between items-center m-4 h-12 w-3/5 gap-12">
        ...
        <button className={(currStep < steps.length - 1) ? "border-none h-full w-1/2 text-xl font-semibold text-[var(--background)] bg-[var(--stepper-curr)] flex-[0.5_0_1]" : "border-none h-full w-1/2 text-xl font-semibold bg-[var(--stepper)] flex-[0.5_0_1] text-[var(--background)]"} onClick={() => {
          setCurrStep(prevState => {
